...
import { createSale, deleteSale, listSales, updateSale } from '../controllers/sales.controller';
import { createSaleSchema, listSalesSchema, saleIdSchema, updateSaleSchema } from '../validators/sales.validator';
