...
exports.customerRoutes.post('/users/:userId/customers', auth_1.authGuard, (0, validate_1.validate)(customers_validator_1.createCustomerSchema), customers_controller_1.createCustomer);
exports.customerRoutes.get('/users/:userId/customers', auth_1.authGuard, (0, validate_1.validate)(customers_validator_1.listCustomerSchema), customers_controller_1.listCustomers);
